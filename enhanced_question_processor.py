...
def main():
    """Example usage of the enhanced QuestionProcessor"""
    processor = QuestionProcessor(output_dir="enhanced_questions")
    
    # Example document content (you would load this from your actual file)
    sample_doc = """
id: 1001
language: en
category: math
...
[STEM]
What is the value of `x^2 + 2x + 1` when `x = 3`?
...
category: physics
type: string
ai_template_id: physics_001

[STEM]
اشرح مفهوم الجاذبية باستخدام المعادلة `F = ma`

[ANSWER]
الجاذبية هي القوة التي تجذب الأجسام نحو الأرض
"""
    
    # Process the sample document
    stats = processor.process_google_doc(sample_doc)
    
    print(f"\nProcessing Results:")
    print(f"Generated {len(stats.generated_files)} files:")
